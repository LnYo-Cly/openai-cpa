...
def reload_all_configs(new_config_dict=None):
    ...
    global NEWAPI_MODE_ENABLE, NEWAPI_URL, NEWAPI_TOKEN, NEWAPI_USER_ID, NEWAPI_MODELS, NEWAPI_GROUP, NEWAPI_CHANNEL_NAME, NEWAPI_CHANNEL_IDS, NEWAPI_SAVE_TO_LOCAL
